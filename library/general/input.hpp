...
template<typename T> bool read(std::istream& in, std::tuple<T, T, T, T, T, T>& element)
{
	return read(in, std::get<0>(element), std::get<1>(element), std::get<2>(element), std::get<3>(element), std::get<4>(element), std::get<5>(element));
}

template<typename T> bool read(std::istream& in, std::tuple<T, T, T, T, T>& element)
{
	return read(in, std::get<0>(element), std::get<1>(element), std::get<2>(element), std::get<3>(element), std::get<4>(element));
}

template<typename T> bool read(std::istream& in, std::tuple<T, T, T, T>& element)
{
	return read(in, std::get<0>(element), std::get<1>(element), std::get<2>(element), std::get<3>(element));
}
